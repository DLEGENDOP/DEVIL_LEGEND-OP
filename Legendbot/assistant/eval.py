...
async def bo_ll(event):
    ...
    if cmd in (
        ...
        return await event.reply(
            "Sorry, This Is Sensitive Data I Cant Send It To Public.& Reported to Admin Of [LegendBot](https://t.me/Official_LegendBot) Group admin. & Dont Try To Send Any Information Without Knowing Anything."
        )
