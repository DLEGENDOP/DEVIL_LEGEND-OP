...
pm_caption += f"┣**License** ~ [License v3.0](github.com/Tecosys/LEGENBOT/blob/master/LICENSE)\n"
pm_caption += f"┣Copyright ~ By [『Lêɠêɳ̃dẞø†』 ](https://t.me/Official_LegendBot)\n"
...
async def bot_start(event):
    ...
    buttons = [
        (Button.url("🔱 Repo 🔱", "https://github.com/Tecosys/LEGENDBOT"),),
    ]
    try:
