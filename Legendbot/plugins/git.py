...
**⚜ 𝙻𝚎𝚐𝚎𝚗𝚍𝚊𝚛𝚢 𝙰𝚏 𝙻𝚎𝚐𝚎𝚗𝚍𝙱𝚘𝚝 ⚜**
  •        [♥️ 𝚁𝚎𝚙𝚘 ♥️](https://github.com/Tecosys/LEGENDBOT)
  •        [♦️ Deploy ♦️](https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FTecosys%2FLEGENDBOT&template=https%3A%2F%2Fgithub.com%2FTecosys%2FLEGENDBOT)
  •  ©️ {Legend_channel} ™
"""
...
@legend.legend_cmd(
    ...
    info={
        ...
        "examples": ["{tr}github Tecosys", "{tr}github -l5 Tecosys"],
    },
)
async def _(event):
