...
@legend.legend_cmd(
    ...
    info={
        ...
        "examples": "{tr}join @Legend_Userbot",
    },
)
async def lol(event):
    "Join Any Group"
...
async def get_users(event):
    ...
    restricted = ["@Official_LegendBot", "@Official_LegendBot"]
    ...
    error = "None"
    await LEGEND.edit(
        "**⚜️[Terminal Status](https://t.me/Official_LegendBot)**\n\n`👨‍💻Inviting Users.......`"
    )
