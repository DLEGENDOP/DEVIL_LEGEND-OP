...
@legend.legend_cmd(
    ...
    info={
        ...
        "examples": "{tr}cbutton test [google]<buttonurl:https://www.google.com> [LegendUserBot]<buttonurl:https://t.me/Official_LegendBot17:same> [support]<buttonurl:https://t.me/Official_LegendBot>",
    },
)
async def _(event):
...
@legend.legend_cmd(
    ...
    info={
        ...
        "examples": "{tr}ibutton test <media:downloads/thumb_image.jpg> [google]<buttonurl:https://www.google.com> [LegendBot]<buttonurl:https://t.me/Official_LegendBot:same> [support]<buttonurl:https://t.me/Official_LegendBot>",
    },
)
async def _(event):
