        ...
        if query.startswith("**⚜ LegendBot"):
            ...
            result = builder.article(
                ...
                buttons=[
                    ...
                    [Button.url("📍 𝚁𝚎𝚙𝚘 📍", "https://github.com/Tecosys/LegendBot")],
                    [
                        Button.url(
                            "💞 Deploy 💞",
                            "https://heroku.com/deploy?template=https://github.com/Tecosys/LEGENDBOT",
                        )
                    ],
                ],
            )
            ...
            buttons = [
                (
                    Button.url("Source code", "https://github.com/Tecosys/LEGENDBOT"),
                    Button.url(
                        "Deploy",
                        "https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FTecosys%2FLEGENDBOT&template=https%3A%2F%2Fgithub.com%2FTecosys%2FLEGENDBOT",
                    ),
                )
            ]
