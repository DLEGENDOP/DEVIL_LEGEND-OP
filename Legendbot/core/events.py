...
async def send_message(
    ...
    *,
    ...
    if safecheck:
        ...
        msg = f"**Sorry, This Is Sensitive Data I Cant Send It To Public.& Reported to Admin Of LegendBot Group [admin](https://t.me/Official_LegendBot). & Dont Try To Send Any Information Without Knowing Anything.** ▶️ [Logger group]({msglink})"
        return await client.sendmessage(
            entity=chatid,
            message=msg,
            send_as=send_as,
