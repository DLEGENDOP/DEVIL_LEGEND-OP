...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/Tecosys/LEGENDUSERBOT"
    )
    ...
    EXTERNAL_REPO = os.environ.get("EXTERNAL_REPO", "True")
    if bool(EXTERNAL_REPO and (EXTERNAL_REPO.lower() != "false")):
        if not url(EXTERNAL_REPO):
            EXTERNAL_REPO = "https://github.com/DLEGENDOP/Devil_Legend_plugins"
    else:
        EXTERNAL_REPO = None
